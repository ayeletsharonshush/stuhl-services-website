...
export const PROJECTS: Project[] = [
  ...
  {
    id: 'bath-newprov',
    title: 'Curb-Less Shower Conversion',
    category: 'Bathroom',
  ...
  {
    id: 'bsmt-newprov',
    title: 'Entertainment Hub & Dance Studio',
    category: 'Basement',
    location: 'New Providence, NJ',
    ...
    testimonial: {
      text: "Sharon at Stuhl Services did a fantastic job on our basement! He was really easy to work with, communication was very clear, and he did everything he promised to do. Thank you Sharon for a stellar job!",
      author: "New Providence Homeowner",
      location: "New Providence, NJ"
    }
  },
  ...
  },
  {
    ...
    testimonial: {
      text: "Sharon is the perfect contractor. His work is professional, he always comes up with great suggestions and he is very organised and courteous. We are already planning our next project with him...",
      author: "Warren Homeowner",
      location: "Warren, NJ"
    }
  },
  {
    id: 'kitchen-gillette',
    title: 'Modern IKEA Kitchen Transformation',
    category: 'Kitchen',
    ...
    testimonial: {
      text: "I always thought that having a kitchen like mine will cost a LOT! But luckily, Sharon proved me wrong. His suggestions and design ideas delivered exactly what I wanted and at a much lower cost than other quotations I received. Thank you Sharon for this amazing Kitchen!!!",
      author: "Gillette Homeowner",
      location: "Gillette, NJ"
    }
  },
  {
